...
const CounselingFormDialog = ({ open, onOpenChange }: CounselingFormDialogProps) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-[95vw] md:max-w-3xl p-0 gap-0 bg-transparent border-none overflow-y-auto h-[110vh] max-h-[110vh] md:h-auto md:max-h-[85vh] !top-[50%] !left-[50%] !translate-x-[-50%] !translate-y-[-50%]">
