...
const CounselingFormDialog = ({ open, onOpenChange }: CounselingFormDialogProps) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-[95vw] md:max-w-3xl p-0 gap-0 bg-transparent border-none overflow-hidden max-h-[90vh] md:max-h-[85vh] mx-auto my-auto flex items-center justify-center">
