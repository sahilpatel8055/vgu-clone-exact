            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 border border-gray-300 rounded-full text-sm outline-none focus:border-[#7F1813]"
                    required
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    className="w-full px-4 py-2.5 border border-gray-300 rounded-full text-sm outline-none focus:border-[#7F1813] bg-white"
                    required
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium mb-1.5">Select State</label>
                  <select
                    className="w-full px-4 py-2.5 border border-gray-300 rounded-full text-sm outline-none focus:border-[#7F1813] bg-white"
                    required
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium mb-1.5">Are You?</label>
                  <select
                    className="w-full px-4 py-2.5 border border-gray-300 rounded-full text-sm outline-none focus:border-[#7F1813] bg-white"
